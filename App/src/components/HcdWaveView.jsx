...
export class HcdWaveView extends Component {
  ...
  artDrawDCChargeWaveView() {
    ...
    if (this.props.tips !== null && typeof this.props.tips !== 'undefined') {
      ...
      <View style={{backgroundColor: 'rgba(0,0,0,0.0)'}}>
        <Surface width={this.surfaceWidth} height={this.surfaceHeigth}>
          ...
          <TextArt
            ...
            fill="#FFFFFF"
            font={'30px "Helvetica Neue", "Helvetica", Arial'}>
  ...
  artDrawACChargeView() {
    ...
    var IconTop = this.props.IconTop;
    var IconLeft = this.props.IconLeft;
    var IconZIndex = this.props.IconZIndex;
    return (
      <View style={{backgroundColor: 'rgba(0,0,0,0.0)'}}>
        <Surface width={this.surfaceWidth} height={this.surfaceHeigth}>
          {this.artDrawBg()}
  ...
  artDrawWave() {
    var powerPercent = parseInt(this.props.powerPercent, 10);
