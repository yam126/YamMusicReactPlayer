...
namespace YamMusicPlayerWebApi.Library
{
    ...
    public class Mp3FileNewHelper
    {
        ...
        public string SaveMp3TagImage(string mp3FilePath, long FileId)
        {
            ...
            //封面图片保存路径
            FullPath = $@"{AppPath}\wwwroot\Mp3Cover";
        ...
        public Mp3FileNewHelper(string mp3FilePath)
        {
            ...
            info.duration = Utils.ConvertDuration(duration);
            #endregion
        ...
        public songinfo AnalyseMp3File()
        {
            songinfo SqliteFile = new songinfo();
            SqliteFile.songId = info.FileId;
            SqliteFile.fileName = System.IO.Path.GetFileName(_mp3FilePath);
            SqliteFile.fileType = "mp3";
            ...
            SqliteFile.createdatetime= DateTime.Now;
            return SqliteFile;
        }
    }
}
